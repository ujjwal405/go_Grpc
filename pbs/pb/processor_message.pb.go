...
type CPU struct {
	...
	NumberTherads uint32  `protobuf:"varint,4,opt,name=number_therads,json=numberTherads,proto3" json:"number_therads,omitempty"`
...
func (x *CPU) GetNumberTherads() uint32 {
	if x != nil {
		return x.NumberTherads
	}
	return 0
}
...
var file_proto_processor_message_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x74, 0x68, 0x65, 0x72, 0x61, 0x64, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x0d, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x54, 0x68, 0x65, 0x72, 0x61, 0x64, 0x73, 0x12, 0x17,
